...
# Assert
TARGET_OTA_ASSERT_DEVICE := IHU353G
...
TW_DEVICE_VERSION := IHU353G by KB
...
# Android 9 A-only recovery on this platform boots from a dedicated recovery
# partition. Keep fastbootd/APEX out for first bring-up, matching the working
# IHU519G tree and the usable IHU353G recovery image layout.
